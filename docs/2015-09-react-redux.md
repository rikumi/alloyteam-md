...
function filmReducer(state = [], action) {
    switch (action.type) {
        case "ADD_FILM": // 更新 state 中的 films 字段
            return [
                {
                    id:
                        state.films.reduce(
                            (maxId, film) => Math.max(film.id, maxId),
                            -1
                        ) + 1,
                    name: action.name,
                },
...
[![屏幕快照 2015-10-01 下午 1.57.51](http://www.alloyteam.com/wp-content/uploads/2015/09/屏幕快照-2015-10-01-下午1.57.51.png)](http://www.alloyteam.com/wp-content/uploads/2015/09/屏幕快照-2015-10-01-下午1.57.51.png)
...
[![屏幕快照 2015-10-01 下午 1.36.52](http://www.alloyteam.com/wp-content/uploads/2015/09/屏幕快照-2015-10-01-下午1.36.52.png)](http://www.alloyteam.com/wp-content/uploads/2015/09/屏幕快照-2015-10-01-下午1.36.52.png)
