...
-   只用 C++ 实现非界面部分，这是官方比较推崇的方案，目前有很多应用是这么做的，比如 [Mailbox](http://channel9.msdn.com/Events/CPP/C-PP-Con-2014/Practical-Cross-Platform-Mobile-CPP-Development-at-Dropbox) 和
