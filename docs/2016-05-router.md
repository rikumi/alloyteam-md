...
可看到 historyModule 中含有机制：historyModule.updateLocation () -> listener ( )，Router 通过对其进行包装开发，针对 historyModule 的机制对 Router 也起到了作用，即 historyModule.updateLocation () 将触发 Router.listen 中的回调函数 。[点击查看完整代码](https://github.com/joeyguo/blog/blob/master/lab/2016/router/package-style.html)  
