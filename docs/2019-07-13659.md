...
TextOperation.transform = function (operation1, operation2) {
    ...
    while (true) {
        ...
        if (isInsert(op1)) {
            ...
            op1 = ops1[i1++];
            continue;
        } // 如果B也是插入，那B’就是插入，但是你的A'也得retain一下，保证下标一致 // 这里可能有两者情况，A可能是R，D // 实例化思考一下，A [R(3),I('a')],B [I('b')],那对于A'来说就应该是[R(4),I('a')]
        if (isInsert(op2)) {
...
![](http://www.alloyteam.com/wp-content/uploads/2019/07/6E64DEED-65D3-42F9-8485-59C84C0FCD6C-300x124.jpg)  
...
这种情况下如何处理，就有点类似于 OT 落地到实践当中，你怎么实现了，上面提到的 github 的那个 repo 的实现其实非常巧妙，你看完注释应该就能全部理解，这里给出[代码链接](https://github.com/Operational-Transformation/ot.js/blob/8873b7e28e83f9adbf6c3a28ec639c9151a838ae/lib/client.js "代码链接")
...
[ot.js](https://github.com/Operational-Transformation/ot.js "ot.js")
