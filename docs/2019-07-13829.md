...
![如果用 flex 实现](https://raw.githubusercontent.com/vorshen/landlord/master/blog/img/7.png)
...
两者的原理如下所示：  
![全部展示 + 黑边](https://raw.githubusercontent.com/vorshen/landlord/master/blog/img/8.png)  
![核心展示 + 无黑边](https://raw.githubusercontent.com/vorshen/landlord/master/blog/img/9.png)
...
下面用张图表示一下整个项目中组件情况  
![项目中组件情况](https://raw.githubusercontent.com/vorshen/landlord/master/blog/img/10.png)

这里假设我们要正式开发一个游戏，借助渲染引擎，意味着不需要考虑 base 部分了。那么大概流程是如下的。

1.  我们要先规划出场景，确定有几个场景。
2.  针对 1 中的场景，确定每个场景有哪些基于 base 的上层组件
...
![BasePukesContainer 分析](https://raw.githubusercontent.com/vorshen/landlord/master/blog/img/11.png)
...
具体原理如下  
![Canvas 中点击判断](https://raw.githubusercontent.com/vorshen/landlord/master/blog/img/12.png)
...
![元素重叠](https://raw.githubusercontent.com/vorshen/landlord/master/blog/img/13.png)  
有两个元素（扑克）存在重叠，玩家点击在了重叠的区域，该如何响应？

#### 组件嵌套

![组件嵌套](https://raw.githubusercontent.com/vorshen/landlord/master/blog/img/14.png)  
刚刚只有两个坐标系，屏幕坐标系和 canvas 坐标系，如果再引入一个 container 呢，是不是又多了一个相对坐标？茫茫无尽的嵌套，该怎么办呢？

#### 不规则图形

![不规则图形](https://raw.githubusercontent.com/vorshen/landlord/master/blog/img/15.png)  
